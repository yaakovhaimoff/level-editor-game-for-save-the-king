...
When the user chooses to save the board he has build, the board will be save in a file named
...
Every object has to show it self, store its locations on the board, there for all the objects
